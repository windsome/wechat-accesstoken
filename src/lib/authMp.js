...
const debug = _debug('app:lib:authMp');
import makeWxappFunctions from './_actionInvoke';

let actions = {
  token: {
    // 见<https://open.weixin.qq.com/cgi-bin/showdocument?action=dir_list&t=resource/res_list&verify=1&id=open1453779503&token=&lang=zh_CN>
    // 返回值: {
